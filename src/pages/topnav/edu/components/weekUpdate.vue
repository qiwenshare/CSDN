  ...
  <div class="weekUpdateWrapper">
    <div class="title">
      ...
      <div class="titleRight">
        <ul>
          <li class="week1 active" @click="weekTabDisplay(weekTab1)"><span>优选课</span></li>
          <li class="week2" @click="weekTabDisplay(weekTab2)"><span>限时挑战2期 A组</span></li>
          <li class="week3" @click="weekTabDisplay(weekTab3)"><span>限时挑战2期 B组</span></li>
        </ul>
      </div>
    </div>
    <div class="content">
